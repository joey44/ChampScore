                    ...
                    <div class="tab-pane" role="tabpanel" id="boxInfo">
                        <div class="boxInfo">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Box Name">
                            </div>
                            <div class="col-md-6">
                        ...
                        <hr>
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><strong>Date of birth</strong></p>
                                </div>
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><strong>Marital Status</strong></p>
                                </div>
                                <div class="col-md-8 col-xs-9">
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><strong>Highest Education</strong></p>
                                </div>
                                <div class="col-md-8 col-xs-9">
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><strong>Specialization</strong></p>
                                </div>
                                <div class="col-md-8 col-xs-9">
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><strong>Year of Passed Out</strong></p>
                                </div>
                                <div class="col-md-8 col-xs-9">
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><strong>Total Experience</strong></p>
                                </div>
                                <div class="col-md-8 col-xs-9">
                                    <div class="row">
