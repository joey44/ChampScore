        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a target="_blank" href=../allScoreboardsPublic.php>All Scoreboards</a>
...
<div class="container">
<div class="row">
<div class="col-md-4 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 col-xs-offset-0">
<div class="form-body">
    ...
    <div class="tab-content">
        ...
        <div id="sectionB" class="tab-pane fade">
            ...
            <input type="text" class="form-control" name="benutzername" placeholder="User Name">
            
            <input type="email" class="form-control" name="email" placeholder="Email">
            
            <input type="password" class="form-control" name="passwort1" placeholder="Password">
             <input type="password"  class="form-control" name="passwort2" placeholder="Confirm Password">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">Set up your Score Board easily and fast</h2>
                    <hr class="light">
